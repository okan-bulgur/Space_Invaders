...
public class Level1 extends Levels{
	...
	private int boostTimeDelay = 0;
	private int maxSpeedX = 5;
	private int maxSpeedY = 5;
	
	public Level1() {
		this.objectMaxNum = new int[]{1, 4, 4, 4, 10};
	...
	public void level(int levelPercentage) {
		...
		case 27:
			...
			break;
		case 33:
			aliensManager.createAlien("alien3", 0, GamePanel.screenWidth/2, 0, GamePanel.screenHeight*2, 4, 4, 6, 6, 300 - boostBulletDelay);
			aliensManager.createAlien("alien3", GamePanel.screenWidth/2, GamePanel.screenWidth, 0, GamePanel.screenHeight*2, 4, 4, 6, 6, 300 - boostBulletDelay);
			break;
		case 35:
			aliensManager.createAlien("alien3", 0, GamePanel.screenWidth/2, 0, GamePanel.screenHeight*2, 4, 4, 6, 6, 300 - boostBulletDelay);
			aliensManager.createAlien("alien3", GamePanel.screenWidth/2, GamePanel.screenWidth, 0, GamePanel.screenHeight*2, 4, 4, 6, 6, 300 - boostBulletDelay);
